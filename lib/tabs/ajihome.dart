              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    height: 50,
                    child: Center(
                      child: Text('HURRY! UP LAST 2 DAYS OF SALE',
                      style: TextStyle(
                 ...
                 slide(carouselimage:carouselimage,height: 250 ),
                      Image(image: AssetImage('assets/photo_2023-11-09_15-52-42.jpg')),
                      Container(
                        height: 50,
                        child: SingleChildScrollView(
                      ...
                      Container(child: Image(image: AssetImage('assets/single bar.jpg')),
                      //  height: 10,
                      width: 450,
                      ),
                      slide(carouselimage: offer, height: 250),
                      Container(child: Image(image: AssetImage('assets/daz.jpg')),
                      ),

                      slide(carouselimage: min, height: 250),

                      Container(child: Image(image: AssetImage('assets/sl.jpeg')),),
                      ...
                      Container(child: Image(image: AssetImage('assets/ph6.jpg')),),
                slide(carouselimage: fest, height: 250),

                 Container(child: Image(image: AssetImage('assets/last.jpeg')),),
